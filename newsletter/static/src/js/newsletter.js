...
openerp.newsletter = function(openerp)
{
    ...
    openerp.web.page.readonly.add('text_email_html',
            'openerp.newsletter.FieldEmailHTMLReadonly');
    ...
    openerp.newsletter.FieldEmailHTMLReadonly = openerp.web_ckeditor4.FieldCKEditor4Readonly.extend({
    });
}
