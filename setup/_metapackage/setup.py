...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-crm_claim_code>=15.0dev,<15.1dev',
        ...
        'odoo-addon-crm_project_task>=15.0dev,<15.1dev',
